...
CSV_PATH = os.path.join(BASE_DIR, 'emissions_per_country', 'annual-co2-emissions-
per-country.csv')
# ============================
...
if not value_col:
raise ValueError('no se encontró ninguna columna de emisiones distinta de
country/code/year')
...
st.markdown(
"""
esta aplicación muestra las emisiones anuales de co₂ por país usando datos
de our world in data.
puedes explorar distintos años y comparar cómo cambia el mapa a lo largo
del tiempo.
"""
)
# cargar datos
...
st.warning(f'no hay datos para el año {year}. el rango válido es
{min_year}–{max_year}.')
return
